...
def main(model, n_decomposition, temperature, task_env, alg_cfg, use_doe, n_improve_iter):
    ...
    main_task = "Train 4 defenders (1 left back, 2 centre backs, and 1 right back) in a defensive counter-attack strategy during an 11 vs 11 football game (other players are controlled by AI and do not require training)."
    num_agents = 4
    num_groups = 2
        ...
        for layer in range(max_layer, -1, -1):
            ...
            for task in tasks:
                ...
                cur_initial_system_scenarios = initial_system_scenarios.format(
                    main_task_scenario = counterattack_easy_code_string) + code_output_tip_scenarios + example_scenarios
...
if __name__ == "__main__":
    main(model="gpt-4-turbo", n_decomposition=1, temperature=1, task_env="gfootball", alg_cfg="ippo_ns",
         use_doe=False, n_improve_iter=0)