...
if __name__ == "__main__":
    ...
    response_id = 0
    layer = 1  # 这个layer对应的是child_layer
    merge_layer = 0   # 似乎没用到target选项
    ...
    child_tasks = [
        {"group_number": 5, "number_of_agents": 1},
        {"group_number": 6, "number_of_agents": 1},
    ]

    # 原来是 group6 group7，感觉不太对劲，也许需要改成group 7 8？代表reward func
    max_reward_code_path_for_each_group={"group4": "reward_layer1_decomposition0_subtask4_iter0_sample0.py",
                                         "group5":"reward_layer1_decomposition0_subtask5_iter0_sample0.py"}
