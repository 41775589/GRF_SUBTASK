...
tasks = [
    ...
    {"num_agents": 2,
     "training_goal": "Specialize in goalkeeper coordination, including strategies to back up the goalkeeper during high-pressure scenarios and to efficiently clear the ball to specific outfield players."},
    {"num_agents": 2,
     "training_goal": "Enhance the defensive adaptation through precise and coordinated stopping and starting movements, focusing on immediate transitions between moving and non-moving states to counter various offensive plays effectively."},
    {"num_agents": 2,
     "training_goal": "Focus on enhancing team synergy during possession changes, emphasizing precise timing and strategic positioning of both offensive and defensive moves."},
    {"num_agents": 2,
     "training_goal": "Specialize in finishing techniques, focusing on optimizing shooting angles and timing, including practice under high-pressure scenarios near the goal."},
    {"num_agents": 2,
     "training_goal": "Train the goalkeeper to master shot stopping, quick decision-making for ball distribution under pressure, and effective communication with defenders."},
    {"num_agents": 2,
     "training_goal": "Focus on high passes and crossing from varying distances and angles to support dynamic attacking plays and improve spatial creation for the team."},
    {"num_agents": 3,
     "training_goal": "Streamline forward training by highlighting scenario-based applications of shooting and passing in game-like contexts, focusing on enhancing precision, decision-making, and strategic positioning."},
    {"num_agents": 2,
     "training_goal": "Master the technique of Short Pass under defensive pressure, focusing on ball retention and effective distribution to aid in defensive 'stability and counter-attack transitions."},
    {"num_agents": 3,
     "training_goal": "'Concentrate on skills that aid in the transition from defense to attack such as Short Pass, Long Pass, and Dribble, ensuring control and movement of the ball under pressure."},
...
if __name__ == "__main__":
    ...
    task="gfootball"
    alg_cfg="mappo"
    # for task_index, task_config in enumerate(tasks[1:], start=1):
