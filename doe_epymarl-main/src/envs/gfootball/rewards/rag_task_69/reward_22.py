...
class CheckpointRewardWrapper(gym.RewardWrapper):
    ...
    def __init__(self, env):
        super().__init__(env)
        self.sticky_actions_counter = np.zeros(10, dtype=int)  # For counting dribbles and sprints

        # Initialize rewards for specific actions
    ...
    def set_state(self, state):
        ...
        sticky_data = from_pickle['CheckpointRewardWrapper']
        self.sticky_actions_counter = np.array(sticky_data['sticky_actions_counter'])
        return from_pickle
    ...
    def reward(self, reward):
        ...
        for rew_index, o in enumerate(observation):
            if o['game_mode'] == 6:  # Penalty kicks
            ...
            # Check for passes (long pass or high pass)
            if o['sticky_actions'][1] == 1 or o['sticky_actions'][6] == 1: # top_left or bottom actions indicating direction changes
