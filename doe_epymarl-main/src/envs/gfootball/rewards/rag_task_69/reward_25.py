...
class CheckpointRewardWrapper(gym.RewardWrapper):
    """A wrapper that adds a dense checkpoint reward focused on offense strategies."""
    ...
    def reward(self, reward):
        ...
        for rew_index in range(len(reward)):
            ...
            # Adding rewards based on game events
            if o['game_mode'] == 6:  # Penalty game mode, implying a shooting scenario
                components["shooting_reward"][rew_index] = self.shooting_reward
            elif o['sticky_actions'][9] and o['ball_owned_team'] == 0:  # Dribbling is active
                components["dribbling_reward"][rew_index] = self.dribbling_reward
            elif o['sticky_actions'][5] or o['sticky_actions'][6]:  # Long pass or High pass is active
