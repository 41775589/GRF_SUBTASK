        ...
        for rew_index in range(len(reward)):
            ...
            if reward[rew_index] == 1:
                if self._max_possession_steps > 5:
                    components["dribbling_sequence_reward"][rew_index] = self._dribbling_sequence_reward * self._max_possession_steps
            ...
            if has_possession:
                ...
                if self._previous_player_position is not None and self._previous_distance_to_goal is not None:
                    ...
                    if current_distance_to_goal < self._previous_distance_to_goal:
                        space_creation_bonus = (self._previous_distance_to_goal - current_distance_to_goal) * self._space_creation_reward * 10
